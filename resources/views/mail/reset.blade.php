...
<a href="{{ $url }}" style="background-color: #00AF66;
    ...
    overflow: hidden;
    text-decoration: none;">сброс пароля</a>
<p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; Margin: 0; margin-bottom: 16px;">
...
<tablecellpadding="0" cellspacing="0" width="100%"
    style="border-top-color:#e8e5ef;border-top-style:solid;border-top-width:1px;box-sizing:border-box;font-family:'-apple-system' , 'blinkmacsystemfont' , 'segoe ui' , 'roboto' , 'helvetica' , 'arial' , sans-serif , 'apple color emoji' , 'segoe ui emoji' , 'segoe ui symbol';margin-top:25px;padding-top:25px">
    <tbody>
        <tr>
            <td
                ...
                <p
                    style="box-sizing:border-box;font-family:'-apple-system' , 'blinkmacsystemfont' , 'segoe ui' , 'roboto' , 'helvetica' , 'arial' , sans-serif , 'apple color emoji' , 'segoe ui emoji' , 'segoe ui symbol';font-size:14px;line-height:1.5em;margin-top:0;text-align:left">
                        Если у вас возникли проблемы с нажатием кнопки "Сбросить пароль", скопируйте и вставьте URL-адрес, указанный ниже в адресную строку браузера: <span class="c4f3af36893d04dabreak-all"
