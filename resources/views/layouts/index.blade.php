...
<html lang="ru">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('front/css/style.css?v=126554256263473426537901643') }}"/>
    ...
    <body>
        ...
        <script src="{{ asset('front/js/app2.js?v=126554256263473426537901643') }}"></script>
