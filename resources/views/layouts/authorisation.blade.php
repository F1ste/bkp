...
<html lang="ru">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('front/css/style.css?v=12422353575342345623434673790542222411') }}"/>
        @hasSection('title')
    ...
    <div class="notifications-container"></div>
        ...
        <script src="{{ asset('front/js/app2.js?v=12422353575342345623434673790542222411') }}"></script>
    </body>
</html>
