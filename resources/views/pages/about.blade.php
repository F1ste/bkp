					...
					<div class="about__content">
						<div class="about__main-info">
							<div class="about__media media-block">
								<picture><source srcset="{{ asset('image/about/about1.webp') }}" type="image/webp"><img src="{{ asset('image/about/about1.png') }}" alt=""></picture>
							</div>
							<div class="about__main-text">
								<div class="about__text-paragraph">
									Платформа «Культурная биржа» – первый в России сайт-агрегатор культурных проектов,
