...
@section('content')
    <div class="page__container">
        ...
        <form action="{{ route('profile.services.store') }}" method="POST">
            @csrf
            <section data-image="{{ route('profile.services.upload') }}" class="collection section-base create-project personal-account">
                                ...
                                <div class="create-project__main-photo form__input add-photo">
                                    <div data-img="{{ route('profile.services.img') }}" class="create-project__drag-and-drop drag-and-drop" id='img1'>
                                        <div class="create-project__drag-wrapper drag-wrapper" id='img1_box'>
                                            <div id='form_img_1'><input id='img1_input' type="file" name="file" class="file__input" accept=".jpeg, .jpg, .png" hidden></div>
                            ...
                            <div class="create-project__main-info">
                                <div class="create-project__main-col">
                                    <div class="create-project__form-item form__item">
                                        ...
                                        <input id="name_proj" type="text" name="name_proj" class="create-project__form-input form__input" placeholder="Название проекта" data-placeholder="Название проекта">
                                    </div>
                                    <div class="create-project__form-item form__item">
                                        <label for="date_service_from" class="create-project__form-label form__label">Сроки начала проекта</label>
                                        <input data-datepicker data-datepicker_1 id="date_service_from" type="text" name="date_service_from" class="create-project__form-input form__input" placeholder="C" data-placeholder="C" readonly autocomplete="off">
                                    </div>
                                    <div class="create-project__form-item form__item">
                                        <label for="date_service_to" class="create-project__form-label form__label">Сроки окончания проекта</label>
                                        <input data-datepicker data-datepicker_2 id="date_service_to" type="text" name="date_service_to" class="create-project__form-input form__input" placeholder="До" data-placeholder="До" readonly autocomplete="off">
                                    </div>
                                </div>
                                <div class="create-project__main-col">
                        ...
                        <div class="create-project__description">
                            <div class="create-project__project-description">
                                <div class="create-project__form-item form__item">
                                    ...
                                    <textarea id="excerpt" type="text" name="excerpt" class="create-project__form-input form__input project-description" placeholder="Не более 10000 символов" data-placeholder="Не более 10000 символов"></textarea>
                                </div>
                            </div>
                            <div class="create-project__project-gallery">
                                    ...
                                    <div class="create-project__gallery-big form__input add-photo">
                                        ...
                                        <div data-img="{{ route('profile.services.img') }}" class="create-project__drag-and-drop drag-and-drop" id='img2'>
                                            <div class="create-project__drag-wrapper drag-wrapper" id='img2_box'>
                                                <div id='form_img_2'><input id='img2_input' type="file" name="file" class="file__input" accept=".jpeg, .jpg, .png" hidden></div>
                                    ...
                                    <div class="create-project__gallery form__input add-photo">
                                        ...
                                        <div data-img="{{ route('profile.services.img') }}" class="create-project__drag-and-drop drag-and-drop" id='img3'>
                                            <div class="create-project__drag-wrapper drag-wrapper" id='img3_box'>
                                                <div id='form_img_3'><input id='img3_input' type="file" name="file" class="file__input" accept=".jpeg, .jpg, .png" hidden></div>
                                                <div class="create-project__upload-logo"><img src="/image/iconsFont/add-img_thin.svg" alt="Загрузите фото "></div>
                                            </div>
                                    ...
                                    <div class="create-project__gallery form__input add-photo">
                                        ...
                                        <div data-img="{{ route('profile.services.img') }}" class="create-project__drag-and-drop drag-and-drop" id='img4'>
                                            <div class="create-project__drag-wrapper drag-wrapper" id='img4_box'>
                                                <div id='form_img_4'><input id='img4_input' type="file" name="file" class="file__input" accept=".jpeg, .jpg, .png" hidden></div>
                                                <div class="create-project__upload-logo"><img src="/image/iconsFont/add-img_thin.svg" alt="Загрузите фото "></div>
                                            </div>
                                    ...
                                    <div class="create-project__gallery form__input add-photo">
                                        ...
                                        <div data-img="{{ route('profile.services.img') }}" class="create-project__drag-and-drop drag-and-drop" id='img5'>
                                            <div class="create-project__drag-wrapper drag-wrapper" id='img5_box'>
                                                <div id='form_img_5'><input id='img5_input' type="file" name="file" class="file__input" accept=".jpeg, .jpg, .png" hidden></div>
                                                <div class="create-project__upload-logo"><img src="/image/iconsFont/add-img_thin.svg" alt="Загрузите фото "></div>
                                            </div>
                                    ...
                                    <div class="create-project__gallery form__input add-photo">
                                        ...
                                        <div data-img="{{ route('profile.services.img') }}" class="create-project__drag-and-drop drag-and-drop" id='img6'>
                                            <div class="create-project__drag-wrapper drag-wrapper" id='img6_box'>
                                                <div id='form_img_6'><input id='img6_input' type="file" name="file" class="file__input" accept=".jpeg, .jpg, .png" hidden></div>
                                                <div class="create-project__upload-logo"><img src="/image/iconsFont/add-img_thin.svg" alt="Загрузите фото "></div>
                                            </div>
                                ...
                                <div class="create-project__add-code">
                                    <div class="create-project__form-item form__item">
                                        ...
                                        <textarea id="video" type="text" name="video" class="create-project__form-input form__input add-code" placeholder="Добавьте код встраивания плеера трансляции" data-placeholder="Не более 10000 символов"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="find-partners__content">
                                <div class="find-partners__partner-block">
                                    <div class="create-project__form-select">
                                        ...
                                        <select data-scroll name="serch[role][]" class="form__select">
                                            <option value="" selected>Выбрать</option>
                                            @foreach ($roles as $el)
                                                <option value="{{ $el->name }}">{{ $el->name }}</option>
                                            @endforeach
                                    ...
                                    <div class="create-project__form-item form__item">
                                        ...
                                        <input id="FormProjectRoleUntil" autocomplete="off" data-datepicker data-datepicker_3 type="text" name="serch[deadline][]" class="create-project__form-input form__input" placeholder="До 10.09.2023" data-placeholder="До 10.09.2023" readonly autocomplete="off">
                                    </div>
                                    <div class="create-project__role-description form__item">
                                        ...
                                        <textarea id="FormProjectPartnerDescription" type="text" name="serch[description][]" class="create-project__form-input form__input project-description" placeholder="Не более 10000 символов" data-placeholder="Не более 10000 символов"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="create-project__footer">
                            ...
                            <div class="create-project__footer-content">
                                <div class="create-project__form-item form__item">
                                    ...
                                    <input id="name" type="text" name="name" class="create-project__form-input form__input" placeholder="Контакт" data-placeholder="Контакт" data-validate data-required data-error="Заполните данное поле">
                                </div>
                                <div class="create-project__form-item form__item">
                                    ...
                                    <input id="tel" type="text" name="tel" class="create-project__form-input form__input" placeholder="8 000 000 00 00" data-placeholder="8 000 000 00 00" data-inputmask="'mask': '8 999 999 99 99'" data-validate data-required="phone" data-error="Введен некорректный телефон">
                                </div>
                                <div class="create-project__form-item form__item">
                                    <label for="Femail" class="create-project__form-label form__label">
                                        Почта*
                                    </label>
                                    <input id="email" type="text" name="email" class="create-project__form-input form__input" placeholder="Email" data-placeholder="Email" data-validate data-required="email" data-error="Введен некорректный Email">
                                </div>
                            </div>
