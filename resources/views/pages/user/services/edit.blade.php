...
<div class="page__container">
    ...
    <section class="create-project personal-account" id="collection-edit" data-id="{{ $id }}"
        data-image="{{ route('profile.services.upload') }}" data-update="{{ route('profile.services.edit') }}">
                ...
                <div class="create-project__general-info">
                    <div class="create-project__form-img">
                        ...
                        <div class="create-project__main-photo form__input add-photo">
                            <div data-img="{{ route('profile.services.img1') }}"
                                class="create-project__drag-and-drop drag-and-drop" id='img1'>
                                @if($collection->img1 == '')
                                <div class="create-project__drag-wrapper drag-wrapper" id='img1_box'>
                                    <form id='form_img_1'><input id='img1_input' type="file" name="file"
                                            class="file__input" accept=".jpeg, .jpg, .png" hidden></form>
                                    <div class="create-project__upload-logo"><img src="/image/iconsFont/add-img.svg"
                                            alt="Загрузите основное фото проекта"></div>
                                ...
                                <div style="display: none;" class="create-project__drag-wrapper drag-wrapper"
                                    id='img1_box'>
                                    <form id='form_img_1'><input id='img1_input' type="file" name="file"
                                            class="file__input" accept=".jpeg, .jpg, .png" hidden></form>
                                    <div class="create-project__upload-logo"><img src="/image/iconsFont/add-img.svg"
                                ...
                                <img id="img1_fin" class='form_img_cul' style="display: block; width: 100%;"
                                    src="{{ $collection->img1 }}">
                    ...
                    <div class="create-project__main-info">
                        <div class="create-project__main-col">
                            <div class="create-project__form-item form__item">
                                <label for="name_proj" class="create-project__form-label form__label">Название
                                    проекта</label>
                            ...
                            <div class="create-project__form-item form__item">
                                ...
                                <input data-datepicker data-datepicker_2 id="date_service_to" type="text"
                                    name="projectName"
                        ...
                        <div class="create-project__main-col">
                            <div class="create-project__form-select">
                                ...
                                <select id="region" data-scroll name="form[]" class="form__select">
                                    ...
                                    <option value="{{$el -> name}}" @if($collection->region == $el -> name) selected
                            ...
                            <div class="create-project__form-select">
                                ...
                                <select id="tip" data-scroll name="form[]" class="form__select">
                                    ...
                                    <option value="{{$el -> name}}" @if($collection->tip == $el -> name) selected
                                        @endif>{{$el -> name}}</option>
                                    @endforeach
                            ...
                            <div class="create-project__form-select">
                                ...
                                <select id="tema" data-scroll name="form[]" class="form__select">
                                    ...
                                    @foreach($event as $el)
                                    <option value="{{$el -> name}}" @if($collection->tema == $el -> name) selected
                                        @endif>{{$el -> name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="create-project__form-select">
                                ...
                                <select id="teg" data-scroll multiple name="form[]" class="form__select">
                                    ...
                                    @foreach($tegs as $el)
                                    <option value="{{$el -> name}}" @if(in_array($el -> name ,$teg)) selected
                                        @endif>{{$el -> name}}</option>
                                    @endforeach
                ...
                <div class="create-project__description">
                    <div class="create-project__project-description">
                        <div class="create-project__form-item form__item">
                            ...
                            <textarea id="excerpt" type="text" name="projectDescription"
                                class="create-project__form-input form__input project-description"
                                placeholder="Не более 10000 символов"
                                data-placeholder="Не более 10000 символов">{{ $collection->excerpt }}</textarea>
                        </div>
                    </div>
                    <div class="create-project__project-gallery">
                        <div class="create-project__form-img">
                            ...
                            <div class="create-project__gallery-big form__input add-photo">
                                ...
                                @if($collection->img2 == '')
                                <div data-img="{{ route('profile.services.img2') }}"
                                    class="create-project__drag-and-drop drag-and-drop" id='img2'>
                                    <div class="create-project__drag-wrapper drag-wrapper" id='img2_box'>
                                        <form id='form_img_2'><input id='img2_input' type="file" name="file"
                                                class="file__input" accept=".jpeg, .jpg, .png" hidden></form>
                                        <div class="create-project__upload-logo"><img
                                                src="/image/iconsFont/add-img_thin.svg" alt="Загрузите фото "></div>
                                ...
                                <div data-img="{{ route('profile.services.img2') }}"
                                    ...
                                    <img id="img2_fin" class='form_img_cul' style="display: block; width: 100%;"
                                        src="{{ $collection->img2 }}">
                        ...
                        <div class="create-project__form-img">
                            <div class="create-project__gallery form__input add-photo">
                                ...
                                @if($collection->img3 == '')
                                <div data-img="{{ route('profile.services.img3') }}"
                                    class="create-project__drag-and-drop drag-and-drop" id='img3'>
                                    <div class="create-project__drag-wrapper drag-wrapper" id='img3_box'>
                                        <form id='form_img_3'><input id='img3_input' type="file" name="file"
                                                class="file__input" accept=".jpeg, .jpg, .png" hidden></form>
                                        <div class="create-project__upload-logo"><img
                                                src="/image/iconsFont/add-img_thin.svg" alt="Загрузите фото "></div>
                                    </div>
                                ...
                                <div data-img="{{ route('profile.services.img3') }}"
                                    ...
                                    <img id="img3_fin" class='form_img_cul' style="display: block; width: 100%;"
                                        src="{{ $collection->img3 }}">
                        ...
                        <div class="create-project__form-img">
                            <div class="create-project__gallery form__input add-photo">
                                ...
                                @if($collection->img4 == '')
                                <div data-img="{{ route('profile.services.img4') }}"
                                    class="create-project__drag-and-drop drag-and-drop" id='img4'>
                                    <div class="create-project__drag-wrapper drag-wrapper" id='img4_box'>
                                        <form id='form_img_4'><input id='img4_input' type="file" name="file"
                                                class="file__input" accept=".jpeg, .jpg, .png" hidden></form>
                                        <div class="create-project__upload-logo"><img
                                                src="/image/iconsFont/add-img_thin.svg" alt="Загрузите фото "></div>
                                    </div>
                                ...
                                <div data-img="{{ route('profile.services.img4') }}"
                                    ...
                                    <img id="img4_fin" class='form_img_cul' style="display: block; width: 100%;"
                                        src="{{ $collection->img4 }}">
                        ...
                        <div class="create-project__form-img">
                            <div class="create-project__gallery form__input add-photo">
                                ...
                                @if($collection->img5 == '')
                                <div data-img="{{ route('profile.services.img5') }}"
                                    class="create-project__drag-and-drop drag-and-drop" id='img5'>
                                    <div class="create-project__drag-wrapper drag-wrapper" id='img5_box'>
                                        <form id='form_img_5'><input id='img5_input' type="file" name="file"
                                                class="file__input" accept=".jpeg, .jpg, .png" hidden></form>
                                        <div class="create-project__upload-logo"><img
                                                src="/image/iconsFont/add-img_thin.svg" alt="Загрузите фото "></div>
                                    </div>
                                ...
                                <div data-img="{{ route('profile.services.img5') }}"
                                    ...
                                    <img id="img5_fin" class='form_img_cul' style="width: 100%; display: block;"
                                        src="{{ $collection->img5 }}">
                        ...
                        <div class="create-project__form-img">
                            <div class="create-project__gallery form__input add-photo">
                                ...
                                @if($collection->img5 == '')
                                <div data-img="{{ route('profile.services.img6') }}"
                                    class="create-project__drag-and-drop drag-and-drop" id='img6'>
                                    <div class="create-project__drag-wrapper drag-wrapper" id='img6_box'>
                                        <form id='form_img_6'><input id='img6_input' type="file" name="file"
                                                class="file__input" accept=".jpeg, .jpg, .png" hidden></form>
                                        <div class="create-project__upload-logo"><img
                                                src="/image/iconsFont/add-img_thin.svg" alt="Загрузите фото "></div>
                                    </div>
                                ...
                                <div data-img="{{ route('profile.services.img6') }}"
                                    ...
                                    <img id="img6_fin" class='form_img_cul' style="width: 100%; display: block;"
                                        src="{{ $collection->img6 }}">
                            ...
                            <div class="create-project__form-item form__item">
                                <label for="video" class="create-project__form-label form__label">Код видео
                                    <button type="button" data-tippy-content="Вставьте код (frame) видео. Плееры, которые поддерживает платформа:
                                                        YouTube, RuTube, «ВКонтакте» или «Одноклассники»"
                                        class="_icon-info"></button>
                                </label>
                                <textarea id="video" type="text" name="addCode"
                                    class="create-project__form-input form__input add-code"
                                    placeholder="Добавьте код встраивания плеера трансляции"
                                    data-placeholder="Не более 10000 символов">{{ $collection->video }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="find-partners__partner-block">
                            ...
                            <div class="create-project__form-select">
                                ...
                                <select data-scroll name="form[]" class="form__select">
                                    ...
                                    @foreach($roles as $el)
                                    <option value="{{$el -> name}}" @if($serchs->sel == $el -> name) selected
                                        @endif>{{$el -> name}}</option>
                                    @endforeach
                            ...
                            <div class="create-project__role-description form__item">
                                <label for="FormProjectPartnerDescription"
                                    class="create-project__form-label form__label">Описание</label>
