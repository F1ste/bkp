                                    ...
                                    <div class="find-partners__content">
                                        ...
                                        <div class="find-partners__partner-block">
                                            ...
                                            <div class="create-project__form-item form__item">
                                                ...
                                                <input id="FormProjectRoleUntil" autocomplete="off" data-datepicker data-datepicker_{{$count}} type="text" name="projectName" class="create-project__form-input form__input" value='{{ $serchs->inp }}' placeholder="До 10.09.2023" data-placeholder="До 10.09.2023">
                                            </div>
