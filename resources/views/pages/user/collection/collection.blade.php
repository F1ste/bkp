...
@section('title', 'Редактировать коллекции')

@section('content')

    <section class="collection section-base" id="collection" data-delete="{{ route('profile.collection.delete') }}">
        <div class="container">
            <div class="section-header">
                <h1>Редактировать коллекции</h1>
            </div>
                    ...
                    @foreach ($collection as $el)
                        <div class="collection-item" data-id="{{ $el->id }}">
                            ...
                            <div class="collection-item__group">
                                ...
                                <div class="collection-item__excerpt">{{ $el->excerpt }}</div>
                            </div>
                        </div>
                    @endforeach
                    <div class="collection-item collection-item__new">
                        <a href="{{ route('profile.collection.new') }}">
