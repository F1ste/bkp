                    ...
                    @if ($collections->count() > 0)
                        ...
                        @else
                            <div class="popular-projects__empty">
                                <div class="emoji text-xxl">&#128237;</div>
                                <div class="info-title text-lg">Нет проектов, соответствующих фильтрам</div>
                                <div>
                                    <button onclick="window.location.search = ''" class="btn btn-filled">Сбросить фильтры</button>
                                </div>
                            </div>
                        @endif
                    </div>
