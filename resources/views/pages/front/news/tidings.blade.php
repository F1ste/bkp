...
<!-- 			<section class="related-news">
				<div class="related-news__container">
					<div class="related-news__heading section__heading">
						<div class="related-news__heading-text section__heading-text">
							<div class="related-news__section-title main-page__section-title">
								Похожие материалы
							</div>
						</div>
					...
					<div class="news-block__items-content">
						...
						<div class="news-block__item news-single__banner">
							<a href="">
								<div class="news-block__item-media media-block">
									<img src="@img/news7.png" alt="Изображение новости">
								</div>
							</a>
						</div>
					</div>
