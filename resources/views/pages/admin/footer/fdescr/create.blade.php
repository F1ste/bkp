...
@section('title', 'Создать описание для футера')

@section('content')
    <div class="page__container" style="min-height: 100vh;">
        <section data-store="{{ route('admin.fdescr.store') }}" id='fdescr-store' class="collection section-base create-project personal-account">
                        ...
                        <div class="create-project__main-info" style="align-items: flex-start;">
                            <div class="create-project__project-description" style="width: 100%;">
                                <div class="create-project__form-item form__item">
                                    ...
                                    <textarea id="descr" type="text" name="descr" class="create-project__form-input form__input project-description" placeholder="Не более 10000 символов" data-placeholder="Не более 10000 символов"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
