							...
							<form data-one-select class="dashboard-filters" method="GET" style="margin-bottom: 30px;">
								<div class="dashboard-filters__row">
									...
									<div class="dashboard-filters__datepicker form__item">
										...
										<input id="dateFrom" autocomplete="off" data-datepicker data-datepicker_1
											type="text" name="date" class="dashboard-filters__form-input form__input"
											placeholder="C" data-placeholder="C">
									</div>
									<div class="dashboard-filters__datepicker form__item">
										<label  class="dashboard-filters__form-label form__label">Сроки
											окончания проекта</label>
										<input id="dateTo" autocomplete="off" data-datepicker data-datepicker_2
											type="text" name="dateTo" class="dashboard-filters__form-input form__input"
								...
								<div class="dashboard-filters__row">
									...
									<div class="serch_news form__item">
										<label
											class="dashboard-filters__form-label form__label">Опубликован</label>
