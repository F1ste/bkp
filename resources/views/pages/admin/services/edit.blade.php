                        ...
                        <div class="create-project__main-info">
                            <div class="create-project__main-col">
                                ...
                                <div class="create-project__form-item form__item">
                                    ...
                                    <input data-datepicker data-datepicker_1 id="date_service_from" type="text" readonly autocomplete="off" name="projectName" value="{{ Carbon\Carbon::parse($collection->date_service_from)->format('d.m.Y') }}" class="create-project__form-input form__input" placeholder="C" data-placeholder="C">
                                </div>
                                <div class="create-project__form-item form__item">
                                    <label for="date_service_to" class="create-project__form-label form__label">Сроки окончания проекта</label>
                                    <input data-datepicker data-datepicker_2 id="date_service_to" type="text" readonly autocomplete="off" name="projectName" value="{{ Carbon\Carbon::parse($collection->date_service_to)->format('d.m.Y') }}" class="create-project__form-input form__input" placeholder="До" data-placeholder="До">
                                </div>
                            </div>
                            <div class="create-project__main-col">
                        ...
                        <div class="profile__form-block">
                            ...
                            <div class="profile__main-info">
                                <div class="profile__form-item form__item">
                                    ...
                                    <input id="org" type="text" class="profile__form-input form__input" placeholder="Название организации" data-placeholder="Название организации" value='{{ $user->org }}'>
                                </div>
                                ...
                                <div class="profile__form-item form__item">
                                    ...
                                    <input id="ruk" type="text" class="profile__form-input form__input" placeholder="Руководитель организации" data-placeholder="Руководитель организации" value='{{ $user->ruk }}'>
                                </div>
                                <div class="profile__form-item form__item">
                                    <label for="inn" class="profile__form-label form__label">ИНН организации</label>
                                    <input id="inn" type="text" class="profile__form-input form__input" placeholder="ИНН организации" data-placeholder="ИНН организации" value='{{ $user->inn }}'>
                                </div>
                                <div class="profile__form-item form__item">
                                    <label for="napr" class="profile__form-label form__label">Направление деятельности</label>
                                    <input id="napr" type="text" class="profile__form-input form__input" placeholder="Направление деятельности" data-placeholder="Направление деятельности" value='{{ $user->napr }}'>
                                </div>
                                <div class="profile__form-item form__item">
                                    <label for="tel_org" class="profile__form-label form__label">Телефон организации</label>
                                    <input id="tel_org" type="text" class="profile__form-input form__input" placeholder="Телефон организации" data-placeholder="Телефон организации" data-inputmask="'mask': '8 999 999 99 99'" value='{{ $user->tel_org }}'>
                                </div>
                            </div>
                        </div>
                        <div class="profile__form-block">
