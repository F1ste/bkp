                        ...
                        <div class="create-project__main-info">
                            <div class="create-project__main-col">
                                ...
                                <div class="create-project__form-item form__item">
                                    ...
                                    <input ata-datepicker data-datepicker_1 id="date_service_from" autocomplete="off" type="text" name="projectName" class="create-project__form-input form__input" placeholder="C" data-placeholder="C">
                                </div>
                                <div class="create-project__form-item form__item">
                                    <label for="date_service_to" class="create-project__form-label form__label">Сроки окончания проекта</label>
                                    <input ata-datepicker data-datepicker_2 id="date_service_to" autocomplete="off" type="text" name="projectName" class="create-project__form-input form__input" placeholder="До" data-placeholder="До">
                                </div>
                            </div>
                            <div class="create-project__main-col">
