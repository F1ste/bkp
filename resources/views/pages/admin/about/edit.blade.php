...
@section('title', 'Редактировать страницу "О Бирже"')

@section('content')
    <div class="page__container" style="min-height: 100vh;">

        <section data-update="{{ route('admin.about.update') }}" data-id="{{ $id }}" id='about-edit' class="collection section-base create-project personal-account">
                        ...
                        <div class="create-project__main-info" style="align-items: flex-start;">
                            <div class="create-project__main-col">
                                <div class="create-project__form-item form__item">
                                    ...
                                    <input style="width:40%" id="title" type="text" name="title" class="create-project__form-input form__input" placeholder="Заголовок" data-placeholder="Название" value="{{ $about->title }}">
                                </div>
