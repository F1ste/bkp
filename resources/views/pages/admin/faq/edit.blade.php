...
@section('title', 'Редактировать страницу "Вопрос-ответ')

@section('content')

    <div class="page__container" style="min-height: 100vh;">

        <section data-update="{{ route('admin.faq.update') }}" data-id="{{ $id }}" id='faq_page-edit' class="collection section-base create-project personal-account">
                        ...
                        <div class="create-project__main-info" style="align-items: flex-start;">
                            <div class="create-project__main-col">
                                <div class="create-project__form-item form__item">
                                    ...
                                    <input style="width:40%" id="quest" type="text" name="quest" class="create-project__form-input form__input" placeholder="Заголовок" data-placeholder="Название" value="{{ $faq->quest }}">
                                </div>
