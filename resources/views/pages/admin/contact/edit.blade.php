...
@section('title', 'Редактировать страницу "Контакты"')

@section('content')
    <div class="page__container" style="min-height: 100vh;">

        <section data-update="{{ route('admin.contact.update') }}" data-id="{{ $id }}" id='contact-edit' class="collection section-base create-project personal-account">
                    ...
                    <div class="create-project__general-info" style="align-items: flex-start;">
                        ...
                        <div class="create-project__add-code">
                            <div class="create-project__form-item form__item">
                                ...
                                <textarea id="map" type="text" name="map" class="create-project__form-input form__input add-code" placeholder="Добавьте код встраивания плеера трансляции" data-placeholder="Не более 10000 символов" style="min-height: 369px;">{{ $contact->map }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
