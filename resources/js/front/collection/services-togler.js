(() => {
    ...
    const servicesItems = servicesContent.querySelectorAll(
        ".collection-miniitems"
    );
    ...
    const forBigDiscription = forBigBlock.querySelector(
    ...
    function serviceToggler(e) {
        ...
        const serviceDateFrom =
            clickedItem.querySelector(".date-from").textContent;
        ...
        const serviceDescription =
            clickedItem.querySelector(".description").textContent;
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const serviceItem = servicesContent.querySelector(
            ".collection-miniitems"
        );
