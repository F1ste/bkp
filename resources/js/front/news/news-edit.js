...
(() => {
    const collectionEdit = document.getElementById("news-edit");
    ...
    var img1 = document.getElementById("img1_fin").getAttribute("src"),
        ...
        img7 = document.getElementById("img7_fin").getAttribute("src");
    ...
    document.querySelectorAll(select.collectionGroup).forEach((el) =>
