 ...
 */
    ...
    (() => {
            ...
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    if (selectItems.length) {
                        ...
                        this.setLogging(`построил селекты: (${selectItems.length})`);
                    } else this.setLogging("нет ни одного select");
                }
            }
        ...
        function initSliders() {
            if (document.querySelector(".project-gallery__slider")) new swiper_core_Swiper(".project-gallery__slider", {
