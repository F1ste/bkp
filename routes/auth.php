...
use Illuminate\Support\Facades\Route;
 ...
 Route::get('authorization', [AdminAuthenticatedSessionController::class, 'create'])->name('authorization');
Route::post('authorization', [AdminAuthenticatedSessionController::class, 'store']);
